...
-   **AI Persona Generation**: A two-phase pipeline researches target populations via LLMs and synthesizes diverse personas, with post-generation diversity validation.
